  ...
  item = <<ITEM
{
  ...
  "capabilities": {
    "SS": ${jsonencode(["task_execute_command","task_get_command_output","task_kill_command","task_download_file","task_create_file","task_delete_file","task_create_share_with_data","task_delete_share_with_data","task_list_shares_with_data","task_launch_container","task_get_container_logs","task_stop_container","task_list_containers","echo","sync_from_workspace","sync_to_workspace","upload_to_workspace","download_from_workspace","ls","del","terminate"])}
  },
  "source_image": {
    "S": "None"
  },
