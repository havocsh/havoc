  ...
  item = <<ITEM
{
  ...
  "capabilities": {
    "SS": ${jsonencode(["get_listeners","get_listener_options","create_listener","kill_listener","kill_all_listeners","get_stagers","create_stager","get_agents","get_stale_agents","remove_agent","remove_stale_agents","execute_agent_shell_command","get_task_id_list","get_shell_command_results","delete_shell_command_results","clear_queued_shell_commands","rename_agent","kill_agent","kill_all_agents","get_modules","search_modules","execute_agent_module","get_stored_credentials","get_logged_events","cert_gen","echo","sync_from_workspace","sync_to_workspace","upload_to_workspace","download_from_workspace","ls","del","terminate"])}
  },
  "source_image": {
  ...
  item = <<ITEM
{
  ...
  "capabilities": {
    "SS": ${jsonencode(["task_execute_command","task_get_command_output","task_kill_command","task_download_file","task_create_file","task_delete_file","task_create_share_with_data","task_delete_share_with_data","echo","sync_from_workspace","sync_to_workspace","upload_to_workspace","download_from_workspace","ls","del","terminate"])}
  },
  "source_image": {
    "S": "None"
  },
