...
cd havoc_control_api/authorizer && zip -r ../../havoc_deploy/aws/terraform/authorizer.zip .
...
cd manage && zip -r ../../havoc_deploy/aws/terraform/manage.zip .
...
cd remote_task && zip -r ../../havoc_deploy/aws/terraform/remote_task.zip .
...
cd task_control && zip -r ../../havoc_deploy/aws/terraform/task_control.zip .
...
cd task_result && zip -r ../../havoc_deploy/aws/terraform/task_result.zip .
